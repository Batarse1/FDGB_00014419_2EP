...
namespace Preparcial
{
    public partial class FrmLogin : Form
    {
        ...
        private void PoblarControlers()
        {
            ...
            //Se cambio Contrasenia por Contrasena debido a que aunque en la base de datos este Contrasenia, en el modelo que se utiliza (Usuario) la varible tiene el nombre de Contrasena
